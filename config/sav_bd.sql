...
CREATE TABLE `cours` (
  `id` int(11) NOT NULL,
  `UID` int(11) NOT NULL,
  `uid_assistant` int(11) DEFAULT NULL,
  ...
  `status` int(11) DEFAULT 1 COMMENT '\r\n1 => Validé\r\n10 => cours terminé',
  `date_creation` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Structure de la table `cours_status`
--

CREATE TABLE `cours_status` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `evaluation_results` (
  `id` int(11) NOT NULL,
  `id_cours` int(11) NOT NULL,
  `moyenne_globale` decimal(5,2) NOT NULL,
...
--
-- Structure de la table `trainer_stats`
--

CREATE TABLE `trainer_stats` (
  `id_stat` bigint(20) NOT NULL,
  `id_formateur` int(11) NOT NULL,
  `total_cours` int(11) DEFAULT 0,
  `total_heures` int(11) DEFAULT 0,
...
--
-- Index pour la table `cours_status`
--
ALTER TABLE `cours_status`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `trainer_stats`
--
...
--
-- AUTO_INCREMENT pour la table `cours_status`
--
ALTER TABLE `cours_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `olms`
--
ALTER TABLE `olms`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `trainer_stats`
--
ALTER TABLE `trainer_stats`
  MODIFY `id_stat` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `evaluation_results`
  ADD CONSTRAINT `evaluation_results_ibfk_1` FOREIGN KEY (`id_cours`) REFERENCES `cours` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `trainer_stats`
--
ALTER TABLE `trainer_stats`
  ADD CONSTRAINT `trainer_stats_ibfk_1` FOREIGN KEY (`id_formateur`) REFERENCES `accounts` (`id`) ON DELETE CASCADE;
COMMIT;
