...
class groupes
{
    ...
    public function create()
    {
        ...
        $sql = "INSERT INTO `groupes` SET " . implode(', ', $sets);
        return $this->dbh->exec($sql);
    }

    public function read($id)
    {
        return $this->dbh->query("SELECT * FROM `groupes` WHERE `id` = '$id'", 3);
    }
    ...
    public function update()
    {
        ...
        $sql = "UPDATE `groupes` SET " . implode(', ', $updates) . " WHERE `id` = '$this->id'";
        return $this->dbh->exec($sql);
    }

    public function delete()
    {
        return $this->dbh->exec("DELETE FROM `groupes` WHERE `id` = '$this->id'");
    }
}
